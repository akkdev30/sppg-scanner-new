// app/(owner)/monitoring/problem_reports.tsx
...
export default function ProblemReportsMonitoringScreen() {
  ...
  const loadData = async (isRefresh = false) => {
    try {
      ...
      Alert.alert(
        "Error",
        error.message || "Gagal memuat data problem reports",
      );
    } finally {
      setLoading(false);
      setRefreshing(false);
  ...
  const handleViewDetails = (item: any) => {
    router.push(`/(owner)/monitoring/problem_reports/${item.id}`);
  };

  const handleExport = () => {
    Alert.alert(
      "Export Problem Reports Data",
  ...
  if (loading && !refreshing) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Memuat data problem reports...</Text>
      </View>
    );
  }
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          <View style={styles.titleRow}>
            ...
            <Text style={styles.title}>Problem Reports</Text>
          </View>
          <Text style={styles.subtitle}>Laporan masalah dalam distribusi</Text>
        </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyTitle}>No problem reports found</Text>
              <Text style={styles.emptyText}>
                {searchQuery || Object.keys(selectedFilters).length > 0
                  ? "Try changing your search or filter criteria"
                  : "No problem report data available"}
              </Text>
            </View>
          }
        />
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Filter Problem Reports</Text>
              ...
              <View style={styles.filterGroup}>
                ...
                {showStatusFilter && (
                  <View style={styles.filterOptions}>
                    {["pending", "investigating", "resolved", "rejected"].map(
                      (status) => (
                        <Pressable
                          key={status}
                          style={[
...
const styles = StyleSheet.create({
  // Copy semua styles dari distribution.tsx
  container: {
    flex: 1,
