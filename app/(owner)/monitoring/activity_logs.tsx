// app/(owner)/monitoring/activity_logs.tsx
...
export default function ActivityLogsMonitoringScreen() {
  ...
  const tableConfig = {
    ...
    searchableColumns: ["activity_type", "description"],
    columns: [
      {
        key: "activity_type",
        label: "Activity Type",
  ...
  const loadData = async (isRefresh = false) => {
    try {
      ...
      Alert.alert("Error", error.message || "Gagal memuat data activity logs");
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  const handleViewDetails = (item: any) => {
    router.push(`/(owner)/monitoring/activity_logs/${item.id}`);
  };
  ...
  if (loading && !refreshing) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Memuat data activity logs...</Text>
      </View>
    );
  }
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          ...
          <Text style={styles.subtitle}>Log aktivitas pengguna</Text>
        </View>
                  ...
                  <View style={styles.filterOptions}>
                    {[
                      ...
                      <Pressable
                        ...
                        style={[
                          styles.filterOption,
                          selectedFilters.activity_type === type &&
...
// Reuse styles from QR codes dengan beberapa penyesuaian
