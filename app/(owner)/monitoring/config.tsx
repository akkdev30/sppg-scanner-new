...
const renderMenuStatus = (value: any) => (
  <Text style={[styles.statusBadge, { backgroundColor: getMenuStatusColor(value) }]}>
    {value?.toUpperCase() || "PENDING"}
  </Text>
);

const renderMenuCondition = (value: any) => (
  <Text style={[styles.statusBadge, { backgroundColor: getMenuConditionColor(value) }]}>
...
const renderDistributionStatus = (value: any) => (
  <Text style={[styles.statusBadge, { backgroundColor: getDistributionStatusColor(value) }]}>
    {value?.toUpperCase() || "PENDING"}
  </Text>
);

const renderDistributionCondition = (value: any) => (
  <Text style={[styles.statusBadge, { backgroundColor: getDistributionConditionColor(value) }]}>
    {value?.toUpperCase() || "NORMAL"}
  </Text>
);
...
const renderReportStatus = (value: any) => (
  <Text style={[styles.statusBadge, { backgroundColor: getReportStatusColor(value) }]}>
    {value?.toUpperCase()}
  </Text>
);

const renderUsedBadge = (value: any) => (
  <Text style={[styles.statusBadge, { backgroundColor: value ? "#FEE2E2" : "#D1FAE5" }]}>
    {value ? "Yes" : "No"}
  </Text>
);
  ...
  users: {
    ...
    columns: [
      ...
      },
      {
        ...
        label: "Status",
        width: 80,
        render: (value: any) => renderStatusBadge(value, value ? "#D1FAE5" : "#FEE2E2"),
      },
      {
        key: "last_login_at",
        label: "Last Login",
