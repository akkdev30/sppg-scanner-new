// app/(owner)/monitoring/qr_codes.tsx
...
export default function QRCodesMonitoringScreen() {
  ...
  const [showUsageFilter, setShowUsageFilter] = useState(false);
      ...
      },
      {
        ...
        render: (value: any) => (
          <Text
            style={[
              styles.statusBadge,
              { backgroundColor: value ? "#D1FAE5" : "#FEF3C7" },
            ]}
          >
            {value ? "Yes" : "No"}
          </Text>
      ...
      },
      {
        ...
        render: (value: any) => (
          <Text
            style={[
              styles.cellText,
              value && new Date(value) < new Date() && styles.expiredText,
            ]}
          >
            {value ? new Date(value).toLocaleDateString("id-ID") : "-"}
          </Text>
  ...
  const loadData = async (isRefresh = false) => {
    try {
      ...
      Alert.alert("Error", error.message || "Gagal memuat data QR codes");
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  const handleViewDetails = (item: any) => {
    router.push(`/(owner)/monitoring/qr_codes/${item.id}`);
  };
  ...
  if (loading && !refreshing) {
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Memuat data QR codes...</Text>
      </View>
    );
  }
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          ...
          <Text style={styles.subtitle}>
            Kode QR untuk verifikasi distribusi
          </Text>
        </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Filter QR Codes</Text>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <View style={styles.filterGroup}>
                <TouchableOpacity
                  ...
                  onPress={() => setShowUsageFilter(!showUsageFilter)}
                >
                  <Text style={styles.filterLabel}>Usage Status</Text>
                  <Ionicons
                    name={showUsageFilter ? "chevron-up" : "chevron-down"}
                    size={20}
                    color="#6B7280"
                  />
                </TouchableOpacity>
                  ...
                  <View style={styles.filterOptions}>
                    {[
                      ...
                      <Pressable
                        ...
                        style={[
                          styles.filterOption,
                          selectedFilters.is_used === status.value &&
...
const styles = StyleSheet.create({
  // Reuse semua styles dari problem_reports.tsx dengan tambahan expiredText
  container: {
    flex: 1,
