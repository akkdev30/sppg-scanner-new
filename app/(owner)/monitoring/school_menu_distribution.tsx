// app/(owner)/monitoring/school_menu_distribution.tsx
...
export default function DistributionMonitoringScreen() {
  ...
  const tableConfig = {
    displayName: "School Menu Distribution",
    icon: "car",
  ...
  const loadData = async (isRefresh = false) => {
    try {
      ...
      Alert.alert("Error", error.message || "Gagal memuat data distribusi");
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  const handleViewDetails = (item: any) => {
    router.push(`/(owner)/monitoring/school_menu_distribution/${item.id}`);
  };
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerInfo}>
          <View style={styles.titleRow}>
            ...
            <Text style={styles.title}>School Menu Distribution</Text>
          </View>
          <Text style={styles.subtitle}>
            Alokasi dan penerimaan menu ke sekolah
          </Text>
        </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>Filter Distributions</Text>
                  ...
                  <View style={styles.filterOptions}>
                    {["pending", "accepted", "rejected"].map((status) => (
                      <Pressable
                        ...
                        style={[
                          styles.filterOption,
                          selectedFilters.received_status === status &&
...
// Reuse styles from menus.tsx
const styles = StyleSheet.create({
  // Copy semua styles dari menus.tsx
  container: {
    flex: 1,
